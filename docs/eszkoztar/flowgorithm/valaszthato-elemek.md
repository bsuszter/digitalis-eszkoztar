...
<div class="mini-grid">
  <div class="mini-card"><span class="mini-icon">⌨️</span><strong>Bemenet / kimenet</strong><span>Adat beolvasása vagy valami kiírása.</span></div>
  <div class="mini-card"><span class="mini-icon">📦</span><strong>Változó</strong><span>Adatok tárolása és értékadása.</span></div>
  <div class="mini-card"><span class="mini-icon">🔀</span><strong>Vezérlés</strong><span>Például elágazás.</span></div>
  <div class="mini-card"><span class="mini-icon">🔁</span><strong>Ciklus</strong><span>Ismétlődő műveletekhez.</span></div>
</div>
...
<div class="related-grid">
  <a href="../szoveg-kiirasa/">
    ...
    <span class="related-text"><strong>Szöveg kiírása</strong><small>Jeleníts meg üzenetet vagy eredményt.</small></span>
  </a>
</div>
