...
<figure class="tool-figure">
  <img src="/digitalis-eszkoztar/images/eszkoztar/kresz-tanpalya/06_modularis.png" alt="Moduláris KRESZ-tanpálya szemléltető ábrája különböző, egymással összeilleszthető pályaelemekkel">
  <figcaption><strong>Moduláris rendszer.</strong> A külön-külön elkészített elemek akkor válnak közös tanpályává, ha ugyanahhoz a méret- és csatlakozási rendszerhez igazodnak.</figcaption>
</figure>
...
<figure class="tool-figure">
  <img src="/digitalis-eszkoztar/images/eszkoztar/kresz-tanpalya/04-edubit-tarto-minta.png" alt="Szemléltető példa az EduBit jelzőlámpa-modulhoz készíthető tartóra">
  <figcaption><strong>Tartóötlet.</strong> Ez csak egy lehetséges kialakítás: a lényeg, hogy a modul stabilan rögzüljön, a LED-ek láthatók maradjanak, és a kábelnek legyen helye.</figcaption>
</figure>

<figure class="tool-figure">
  <img src="/digitalis-eszkoztar/images/eszkoztar/kresz-tanpalya/05-edubit-tarto-tinkercad-pelda.png" alt="Tinkercadben készített példa EduBit jelzőlámpa-tartó tervezésére">
  <figcaption><strong>Tinkercad-példa.</strong> A tartó felépítése egyszerű testekből is megoldható. A pontos belső méreteket mindig a tényleges EduBit-modul lemérése után állítsd be!</figcaption>
</figure>
...
<figure class="tool-figure">
  <img src="/digitalis-eszkoztar/images/eszkoztar/kresz-tanpalya/07-jelzolampa-tarto.png" alt="Jelzőlámpa-tartó szemléltető mintája a KRESZ-tanpályához">
  <figcaption><strong>Egy lehetséges kész forma.</strong> A külső megjelenés változhat, de a stabilitás, a megfelelő magasság, a modul szabadon hagyása és a kábel kivezetése minden tervnél fontos.</figcaption>
</figure>
