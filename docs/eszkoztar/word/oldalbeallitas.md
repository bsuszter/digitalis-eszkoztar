...
<div class="article-hero">
  <span class="article-kicker">WORD · OLDAL</span>
  <h2>Tájolás, margó és vonalzó egy helyen</h2>
  <p>Ha a feladat pontos oldalméretet vagy margót kér, ezeket ne szemre állítsd be!</p>
</div>
...
<div class="quick-note"><strong>Alapeset</strong><span>A Word új dokumentuma általában álló tájolású. Csak akkor változtasd meg, ha a feladat ezt kéri.</span></div>
...
<div class="project-panel project-panel--gold">
  ...
  <p>A margó az oldal szélétől mért üres terület. Nem ugyanaz, mint a bekezdés behúzása.</p>
</div>
